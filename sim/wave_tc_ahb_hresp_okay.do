...
add wave -noupdate /tb_top/dut/HRESP
add wave -noupdate /tb_top/dut/HRESP1
...
add wave -noupdate /tb_top/dut/PSLVERR1
add wave -noupdate /tb_top/dut/PSLVERR2
add wave -noupdate /tb_top/dut/PSLVERR3
add wave -noupdate /tb_top/dut/PWDATA
add wave -noupdate /tb_top/dut/PWRITE
add wave -noupdate /tb_top/dut/HWRITE
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {152669 ps} 0}
...
update
WaveRestoreZoom {0 ps} {477750 ps}
